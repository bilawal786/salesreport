                 ...
                 <div class="row">
                   <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input id="oldpass" type="text" class="form-control" name="firstname" required=""  value="{{$lead->firstname}}">
                    </div>
                   </div>
                   <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Last Name:</label>
                       <input id="password" type="text" class="form-control" name="lastname" required="" value="{{$lead->lastname}}">
                    </div>
                   </div>
                   <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputFile">Email:</label>
                       <input id="password-confirm" type="email" class="form-control" name="email" required="" value="{{$lead->email}}">
                   </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Phone:</label>
                      <input id="oldpass" type="number" class="form-control" name="phone" required="" value="{{$lead->phone}}">
                    </div>
                   </div>
                   <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Country:</label>
                       <input id="password" type="text" class="form-control" name="country" required="" value="{{$lead->country}}">
                    </div>
                   </div>
                   <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <label>Call Back Date and time:</label>
                    <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" name="call_date" data-target="#reservationdatetime" value="{{$lead->call_date}}"/>
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Follow up Date:</label>
                       <input id="password" type="date" class="form-control" name="follow_date" value="{{$lead->follow_date}}">
                    </div>
                   </div>
                   <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputFile">Source:</label>
                       <input id="password-confirm" type="text" class="form-control" name="source" required="" value="{{$lead->source}}">
                   </div>
                  </div>
                  </div>
                </div>
