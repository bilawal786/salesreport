              ...
              <form action="{{ route('profile.update') }}" method="post"  enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="name" placeholder="Name" value="{{Auth::user()->name}}">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                       <input type="file" class="form-control"  name="image" onchange="readURL(this);" accept="image/*">
                         <img src="{{asset(Auth::user()->image)}} " style="height: 80px; width: 80px;" id="one">
                      </div>
                    </div>
                  </div>
                </div>
